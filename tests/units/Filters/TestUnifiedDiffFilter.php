...
class TestUnifiedDiffFilter extends TestCase {
    ...
    public function testBinarySearchInRange() {
        ...
        $this->assertTrue($diffFilter->binarySearch('Example.php', 15));

        // Line within second range
        $this->assertTrue($diffFilter->binarySearch('Example.php', 35));

        // Line outside ranges
        $this->assertFalse($diffFilter->binarySearch('Example.php', 25));
    }
    ...
    public function testBinarySearchExactMatch() {
        ...
        // Exact matches
        $this->assertTrue($diffFilter->binarySearch('Example.php', 5));
        $this->assertTrue($diffFilter->binarySearch('Example.php', 10));
        $this->assertTrue($diffFilter->binarySearch('Example.php', 15));

        // Non-matches
        $this->assertFalse($diffFilter->binarySearch('Example.php', 7));
        $this->assertFalse($diffFilter->binarySearch('Example.php', 20));
    }
    ...
    public function testBinarySearchMixedArray() {
        ...
        // Single line matches
        $this->assertTrue($diffFilter->binarySearch('Example.php', 5));
        $this->assertTrue($diffFilter->binarySearch('Example.php', 20));

        // Range matches
        $this->assertTrue($diffFilter->binarySearch('Example.php', 10));
        $this->assertTrue($diffFilter->binarySearch('Example.php', 12));
        $this->assertTrue($diffFilter->binarySearch('Example.php', 15));
        $this->assertTrue($diffFilter->binarySearch('Example.php', 25));
        $this->assertTrue($diffFilter->binarySearch('Example.php', 28));
        $this->assertTrue($diffFilter->binarySearch('Example.php', 30));

        // Non-matches
        $this->assertFalse($diffFilter->binarySearch('Example.php', 7));
        $this->assertFalse($diffFilter->binarySearch('Example.php', 18));
        $this->assertFalse($diffFilter->binarySearch('Example.php', 22));
    }
    ...
    public function testBinarySearchEdgeCases() {
        ...
        $this->assertFalse($emptyFilter->binarySearch('Example.php', 10));

        // Non-existent file
        $filter = new UnifiedDiffFilter(['OtherFile.php' => [[10, 10]]]);
        $this->assertFalse($filter->binarySearch('Example.php', 10));

        // Empty line array for file
        $emptyLineFilter = new UnifiedDiffFilter(['Example.php' => []]);
        $this->assertFalse($emptyLineFilter->binarySearch('Example.php', 10));
    }

    /**
     * Test integration between parse() and binarySearch via shouldEmit()
     *
     * @return void
     */
